...
[![Javadocs](https://www.javadoc.io/badge/io.github.twonote/radosgw-admin4j.svg)](https://static.javadoc.io/io.github.twonote/radosgw-admin4j/2.0.0/index.html?org/twonote/rgwadmin4j/RgwAdmin.html)
...
* [io.github.twonote.radosgw-admin4j:2.0.0](https://search.maven.org/#artifactdetails%7Cio.github.twonote%7Cradosgw-admin4j%7C2.0.0%7Cjar)
...
We support all types of operation includes **User**, **Subuser**, **Key**, **Bucket**, **Capability**, **Quota** and **Usage**. Please check all available operations in [![Javadocs](https://www.javadoc.io/badge/io.github.twonote/radosgw-admin4j.svg)](https://static.javadoc.io/io.github.twonote/radosgw-admin4j/2.0.0/index.html?org/twonote/rgwadmin4j/RgwAdmin.html)
