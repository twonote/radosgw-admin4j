...
### Account Management (Ceph Squid and later)

```java
// Create an account
Account account = rgwAdmin.createAccount("my-account");

// Create an account with custom parameters
Account account = rgwAdmin.createAccount("my-account", 
    ImmutableMap.of(
...
Optional<Account> account = rgwAdmin.getAccountInfo("RGW12345678901234567");

// Modify an account
Account updated = rgwAdmin.modifyAccount("RGW12345678901234567",
    ImmutableMap.of("max-buckets", "2000"));
