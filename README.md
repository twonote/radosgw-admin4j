...
* Quality and compatibility - [Continuous Integration](https://travis-ci.org/twonote/radosgw-admin4j) and tests against the least Ceph version (**Luminous**/Kraken currently, and we will support **Mimic** when the the corresponding official docker image available)
